package com.denis_adidas.component.ToDoForm;
...
public class ToDo extends javax.swing.JPanel {
    ...
    void init() {
        ...
        AddTaskForm.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                addTaskFromTextArea();
            }
    ...
    private void initComponents() {
        ...
        dateChooser1 = new com.denis_adidas.component.datechooser.DateChooser();
    ...
    private void searchButtonActionPerformed(java.awt.event.ActionEvent evt) {
        if (!searchBar.getText().equals("") && !searchBar.getText().equals("smth"))
            updateTasksPanel(TaskListManager.getInstance().searchText(searchBar.getText()));
        if (searchBar.getText().equals("smth"))
            updateTasksPanel();
    ...
    private void addButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButton1ActionPerformed
        if (selectedTaskForm != null) {
            if (subTaskAddForm.getText() != null && !subTaskAddForm.getText().equals("Sub task")) {
    ...
    private com.denis_adidas.component.datechooser.DateChooser dateChooser1;
