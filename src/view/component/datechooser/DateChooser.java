package view.component.datechooser;
...
public final class DateChooser extends javax.swing.JPanel {
    ...
    private void execute() {
        setForeground(new Color(37,49,50));
    ...
    private void initComponents() {
        ...
        cmdForward = new view.component.datechooser.Button();
        MY = new javax.swing.JLayeredPane();
        cmdMonth = new view.component.datechooser.Button();
        lb = new javax.swing.JLabel();
        cmdYear = new view.component.datechooser.Button();
        cmdPrevious = new view.component.datechooser.Button();
        slide = new view.component.datechooser.Slider();

        setBackground(new java.awt.Color(255, 255, 255));

        header.setBackground(new java.awt.Color(37, 49, 50));
        header.setMaximumSize(new java.awt.Dimension(262, 40));

        cmdForward.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        cmdForward.setForeground(new java.awt.Color(224, 223, 218));
        cmdForward.setIcon(new javax.swing.ImageIcon("D:\\NetBeans_projects\\TaskManager\\src\\main\\java\\com\\denis_adidas\\component\\datechooser\\forward.png")); // NOI18N
        cmdForward.setFocusable(true);
        cmdForward.setFont(new java.awt.Font("Inter", 0, 14)); // NOI18N
        ...
        MY.setBackground(new java.awt.Color(37, 49, 50));
        MY.setFont(new java.awt.Font("Inter", 0, 16)); // NOI18N
        java.awt.FlowLayout flowLayout1 = new java.awt.FlowLayout(1, 5, 0);
        ...
        cmdMonth.setFont(new java.awt.Font("Inter", 0, 14)); // NOI18N
        ...
        cmdYear.setFont(new java.awt.Font("Inter", 0, 14)); // NOI18N
        ...
        cmdPrevious.setForeground(new java.awt.Color(224, 223, 218));
        cmdPrevious.setIcon(new javax.swing.ImageIcon("D:\\NetBeans_projects\\TaskManager\\src\\main\\java\\com\\denis_adidas\\component\\datechooser\\previous.png")); // NOI18N
        cmdPrevious.setFocusable(true);
        cmdPrevious.setFont(new java.awt.Font("Inter", 0, 14)); // NOI18N
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(slide, javax.swing.GroupLayout.DEFAULT_SIZE, 305, Short.MAX_VALUE)
    ...
    private view.component.datechooser.Button cmdForward;
    private view.component.datechooser.Button cmdMonth;
    private view.component.datechooser.Button cmdPrevious;
    private view.component.datechooser.Button cmdYear;
    private javax.swing.JPanel header;
    private javax.swing.JLabel lb;
    private javax.swing.JPopupMenu popup;
    private view.component.datechooser.Slider slide;
